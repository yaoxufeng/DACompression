...
CUDA_VISIBLE_DEVICES=1 python train.py 'Office31' './Datasets/office31/amazon/images/' './Datasets/office31/webcam/images/' './Checkpoint/AW_train' --arch 'vgg16' --num_epoch 50 --optimizer 'SGD' --lr '1e-3' --lr_scheduler 'cosine_decay' --k 1 --batch-size 32 --workers 8 --eval-freq 3 --gpu_ids 0  --method "train" --log_file "./log/AW_train_result.log" --tensorboard_file "./log/AW/train_tensorboard/"
