...
#CUDA_VISIBLE_DEVICES=1,2,3,4 python train.py 'Office31' './Datasets/office31/amazon/images/' './Datasets/office31/webcam/images/' './Checkpoint/AW_mixmatch' --arch 'resnet50' --num_epoch 50 --optimizer 'SGD' --lr '1e-3' --lr_scheduler 'cosine_decay' --batch-size 32 --workers 8 --eval-freq 3 --gpu_ids 0 1 2 3 --k 2 --method "train_mixmatch" --log_file "./log/AW_train_mixmatch_result.log" --tensorboard_file "./log/AW/train_mixmatch_tensorboard/"
